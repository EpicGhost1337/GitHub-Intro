...
public class Card extends Group {
	...
	public Card(int suit, int value) { // Ger Spader, Hjärte, Diamant, Klöver för värde //
		...
		Rectangle background = new Rectangle(WIDTH, HEIGHT); // Själva Kortens backgrund och storlekt //
